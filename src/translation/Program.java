...
public class Program {
	...
	public void generateJavaBytecodeForTest() {
		// consideriamo una classe alla volta e generiamo il suo Java bytecode
		for (ClassType clazz: ClassType.getAll()){
			...
			try {
				// getJavaClass: trasforma il generatore in una rappresentazione
				// del file class in memoria. Viene salvato in memoria con il 
				// metodo dump
